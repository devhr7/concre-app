...
const initFilters = () => {
  filters.value = {
    ...
    sucursal_nombre: { value: null, matchMode: FilterMatchMode.STARTS_WITH},
  }
}
initFilters()
...
<template>
  ...
  <DataTable :value="store.items" paginator :globalFilterFields="['nombre','codigo','sucursal_nombre']" v-model:filters="filters"
    filterDisplay="menu" :rows="10" :rowsPerPageOptions="[5, 10, 20, 50]">

    <template #header>
      <div class="flex flex-wrap gap-2 items-center justify-between">
        <h4 class="m-0">Linea Produccion</h4>
        <IconField>
          <InputIcon>
    ...
    <Column field="sucursal_nombre" header="Sucursal" sortable />
